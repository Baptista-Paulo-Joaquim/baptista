  ...
  return (
    <>
      <nav className="bg-gray-800 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="#" className="flex items-center space-x-3">
            <h1 className="text-green-300 font-extrabold sm:text-4xl">
              Baptista
            </h1>
          </a>
          ...
          >
            <ul className="flex flex-col md:flex-row md:space-x-8 font-medium p-4 md:p-0 mt-4 md:mt-0 border border-gray-100 rounded-lg bg-gray-800 md:border-0 text-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a href="/" className="block py-2 px-3 text-green-300">
                  Home
                </a>
              </li>
              <li>
                <a
                  href="/about"
                  className="block py-2 px-3 hover:text-green-300"
                >
                  About
                </a>
              </li>
              ...
              <li className="relative group">
                <span className="block py-2 px-3 hover:text-green-300 cursor-pointer">
                  More ▼
                </span>
              ...
              <li className="relative group">
                ...
                <ul className="absolute hidden group-hover:block bg-gray-700 left-0 top-full shadow-lg w-15">
                  <li>
                    <button className="block px-4 py-2 hover:bg-white w-full text-left">
                      <US title="United States" className="w-7" />
                    </button>
                  </li>
                  <li>
                    <button className="block px-4 py-2 hover:bg-white w-full text-left">
                      <MZ title="Mozambique" className="w-7" />
                    </button>
                  </li>
                </ul>
              </li>
      ...
      <section className="h-full bg-gray-900 text-white">
        <div className="mx-auto max-w-screen-xl px-4 py-5 flex h-full items-center">
          <div className="mx-auto max-w-3xl text-justify">
            ...
            <p className="mt-6 text-lg">
              Hello, my name is{" "}
              <span className="font-semibold">Baptista Paulo Joaquim</span>, and
              I am a <span className="font-semibold">software engineer</span>{" "}
              passionate about technology and innovation. I was born on{" "}
              <span className="font-semibold">February 27, 2001</span>, in the
              city of
              <span className="font-semibold"> Beira, Mozambique</span>.
            </p>
            <p className="mt-4 text-lg">
              ...
              , and I am currently improving my skills as an{" "}
              <span className="font-semibold">intern at Mesquita Group</span>,
              working in{" "}
              <span className="font-semibold">
            ...
            <p className="mt-4 text-lg">
              In addition to my work in technology, I also operate in the
              logistics sector, managing a
              <span className="font-semibold">
                {" "}
                freight transportation company
              </span>
              . My mission is to provide efficient solutions in both software
              development and logistics process optimization.
            </p>
            <p className="mt-4 text-lg">
              I am always eager to learn and grow, combining my software
              engineering expertise with a strategic business mindset. If you’d
              like to get in touch or collaborate on projects, feel free to
              reach out!
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-md">
            ...
            <form className="mt-6">
              <div className="relative max-w-lg">
                ...
                <button className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-green-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-green-400">
                  Subscribe
                </button>
              </div>
            </form>
            ...
            <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
              ...
              <div>
                ...
                <ul className="mt-6 space-y-1">
                  ...
                  <li>
                    <a
                      className="text-gray-400 transition hover:text-gray-700/80"
                      href="#"
                    >
                      {" "}
                      Contact{" "}
