...
export default function Home() {
 ...
 <nav className="bg-gray-800 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    ...
    <section className="h-220 bg-gray-900 text-white">
            <div className="mx-auto max-w-screen-xl px-4 py-30 flex h-full items-center">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mt-6 text-lg">
                        Hello, my name is <span className="font-semibold">Baptista Paulo Joaquim</span>,
                        and I am a <span className="font-semibold">software engineer</span> passionate about technology and innovation.
                        I was born on <span className="font-semibold">February 27, 2001</span>, in the city of 
                        <span className="font-semibold"> Beira, Mozambique</span>.
                    </p>
                    <p className="mt-4 text-lg">
                        I graduated in <span className="font-semibold">Software Engineering</span> from
                        <span className="font-semibold"> Jean Piaget University of Mozambique</span>, and I am currently improving my skills 
                        as an <span className="font-semibold">intern at Mesquita Group</span>, working in <span className="font-semibold">
                        software development and architecture</span>.
                    </p>
                    <p className="mt-4 text-lg">
                        In addition to my work in technology, I also operate in the logistics sector, managing a 
                        <span className="font-semibold"> freight transportation company</span>. My mission is to provide 
                        efficient solutions in both software development and logistics process optimization.
                    </p>
                    <p className="mt-4 text-lg">
                        I am always eager to learn and grow, combining my software engineering expertise 
                        with a strategic business mindset. If you’d like to get in touch or collaborate on projects, 
