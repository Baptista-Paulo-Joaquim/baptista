        ...
        <div className="mx-auto max-w-screen-xl px-4 py-20 flex h-full items-center">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-lg">
              Feel free to reach out for collaborations, business inquiries, or
              just to say hi!
            </p>
            ...
            <div className="mt-6 space-y-4 text-start">
              <p className="text-lg">
                ...
                <a
                  href="mailto:baptista@example.com"
                  className="text-green-300 hover:underline"
                >
                  baptistajoaquim0@gmail.com
                </a>
              </p>
              <p className="text-lg">
                🔗 <span className="font-semibold">LinkedIn : </span>
                <a
                  href="https://www.linkedin.com/in/baptista-joaquim-56b056219/"
                  className="text-green-300 hover:underline"
                  target="_blank"
