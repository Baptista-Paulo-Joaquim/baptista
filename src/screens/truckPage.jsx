  ...
  return (
    <>
          ...
          >
            <ul className="flex flex-col md:flex-row md:space-x-8 font-medium p-4 md:p-0 mt-4 md:mt-0 border border-gray-100 rounded-lg bg-gray-800 md:border-0 text-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a
                  href="/"
                  className="block py-2 px-3 text-green-300"
                  aria-current="false"
                >
                  Home
                </a>
      ...
      <section className="h-full bg-gray-900 text-white flex items-center">
        <div className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row items-center mb-4">
          {/* Left Column */}
          <div className="lg:w-1/2 text-center lg:text-left mt-10">
            <h1 className="bg-gradient-to-r from-green-400 to-purple-200 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl">
              ...
              <span className="sm:block sm:text-2xl">Cargo transportation</span>
            </h1>

            <p className="mt-4 max-w-xl sm:text-xl/relaxed text-justify">
              About Nsualulu Investimentos Nsualulu Investimentos is a
              Mozambican company specializing in cargo transportation within the
              country. With a modern fleet and a highly qualified team, we
              ensure efficient, safe, and timely logistics solutions to meet our
              clients' needs. We operate in the transportation of goods for
              various sectors, including trade, industry, and agriculture,
              providing a reliable service that drives business growth and
              productivity in Mozambique. Our commitment is to excellence,
              ensuring fast deliveries and high-quality customer service. If you
              are looking for a trustworthy logistics partner for your
              operations, Nsualulu Investimentos is ready to serve you!
            </p>
