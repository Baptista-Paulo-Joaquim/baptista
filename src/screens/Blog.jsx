  ...
  const posts = [
    {
      ...
      description: "Aprenda os conceitos básicos do Node.js e como começar seu primeiro projeto.",
      icon: <FaNodeJs className="text-green-400 text-6xl" />,
      link: "#"
    },
    {
      title: "Manipulação de Arquivos com Python",
      description: "Veja como ler e escrever arquivos usando Python de maneira eficiente.",
      icon: <FaPython className="text-blue-400 text-6xl" />,
      link: "#"
    },
    {
        title: "Consultas SQL com MySQL",
        description: "Veja como criar, ler, escrever e actualizar dados com MySQL.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {posts.map((post, index) => (
            <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center">
              {post.icon}
              <h3 className="mt-4 text-xl font-semibold text-center">{post.title}</h3>
