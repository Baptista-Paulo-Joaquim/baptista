...
import { FaNodeJs, FaPython, FaExternalLinkAlt } from "react-icons/fa";
  ...
  const posts = [
    {
      ...
      description:
        "Aprenda os conceitos básicos do Node.js e como começar seu primeiro projeto.",
      icon: <FaNodeJs className="text-green-400 text-6xl" />,
      link: "#",
    },
    {
      title: "Manipulação de Arquivos com Python",
      description:
        "Veja como ler e escrever arquivos usando Python de maneira eficiente.",
      icon: <FaPython className="text-blue-400 text-6xl" />,
      link: "#",
    },
    {
      title: "Consultas SQL com MySQL",
      description:
        "Veja como criar, ler, escrever e actualizar dados com MySQL.",
      icon: <SiMysql className="text-blue-300 text-6xl" />,
      link: "#",
    },
  ];
        ...
        <div className="max-w-screen-xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 py-2">
            {posts.map((post, index) => (
              ...
              >
                {post.icon}
                <h3 className="mt-4 text-xl font-semibold text-center text-green-100">
                  {post.title}
                </h3>
