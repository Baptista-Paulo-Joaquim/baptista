      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className={`${isOpen ? "block" : "hidden"} w-full md:flex md:w-auto`}>
          <ul className="flex flex-col md:flex-row md:space-x-8 font-medium p-4 md:p-0 mt-4 md:mt-0 border border-gray-100 rounded-lg bg-gray-800 md:border-0 text-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li><a href="/portfolio" className="block py-2 px-3 hover:text-cyan-300">Portfolio</a></li>
        ...
        <section className="bg-gray-900 text-white">
            <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
                ...
                <h1
                    className="bg-gradient-to-r from-green-300 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"
                >
                    Baptista Joaquim
    ...
    <div className="mx-auto max-w-md">
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-cyan-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
          >
            Subscribe
          </button>
        </div>
