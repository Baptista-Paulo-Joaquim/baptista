          ...
          >
            <ul className="flex flex-col md:flex-row md:space-x-8 font-medium p-4 md:p-0 mt-4 md:mt-0 border border-gray-100 rounded-lg bg-gray-800 md:border-0 text-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li
                ...
                onMouseEnter={() =>
                  window.innerWidth >= 768 && setMoreOpen(true)
                }
                onMouseLeave={() =>
                  window.innerWidth >= 768 && setMoreOpen(false)
                }
              >
                ...
                {moreOpen && (
                  <ul className="absolute bg-gray-700 text-white left-0 top-full shadow-lg z-50 w-40">
                    <li>
                      <a
                        href="/blog"
              ...
              <li className="relative group">
                ...
                <ul className="absolute hidden group-hover:block bg-gray-700 left-0 top-full shadow-lg w-20">
                  <li>
        ...
        <div className="max-w-screen-xl mx-auto px-4 flex flex-col lg:flex-row items-center m-5">
          ...
          <div className="lg:w-1/2 text-center lg:text-left mt-10">
            ...
            <p className="mt-4 max-w-xl sm:text-xl/relaxed text-justify">
              I am a software engineer passionate about technology, web
              development, and cybersecurity. I have experience in JavaScript,
              TypeScript, React.js, Node.js, Docker, PostgreSQL, and digital
              security, creating efficient and scalable solutions.
              <br />
              <br />
              Currently, I also work in the field of systems development,
              applying technology to optimize processes and improve operational
              efficiency.
              <br />
              <br />
              In my portfolio, I share projects, technical articles, and
              services I offer. I am always open to new opportunities and
              challenges!
              <br />
              <br />
