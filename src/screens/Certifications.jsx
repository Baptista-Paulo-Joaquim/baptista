    ...
    <>
      ...
      <section className="bg-gray-900 text-white py-13">
        <div className="max-w-screen-xl mx-auto px-6">
          <h2 className="bg-gradient-to-r from-green-400 to-purple-200 bg-clip-text text-4xl font-extrabold text-transparent sm:text-4xl text-center mb-8">
            Certifications
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
            <div className="p-4 border border-gray-700 rounded-lg hover:cursor-pointer hover:bg-gray-700">
              <h3 className="text-xl text-green-50 font-semibold">
            ...
            <div className="p-4 border border-gray-700 rounded-lg hover:cursor-pointer hover:bg-gray-700">
              ...
              <p className="text-gray-400 text-sm">
                Issued by Instituto Federal de Educação, Ciência e Tecnologia do
